...
/// The finished-capture row's own lifecycle, plus the activity teardown that
/// shares it: the things that may change or retire a result row — a newer
/// session taking the activity over, a confirmed Copy from the row itself, and
/// an outright end. All of them have to name the completion they belong to,
/// because the activity outlives any one session.
