...
## 2026-04-08 — PR #279: No action (MCP auth gap)
All GitHub MCP reads returned empty arrays for PR #279. Consistent with documented pattern. Took no action; waiting for re-trigger with live context.
