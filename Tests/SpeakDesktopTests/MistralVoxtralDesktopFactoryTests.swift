...
final class MistralVoxtralDesktopFactoryTests: XCTestCase {
    ...
    func testBatchUnknownAndUnimplementedRoutesStayUnavailable() {
        ...
        // Gladia's, Cartesia's and Rev.ai's shared clients joined the projection
        // alongside Voxtral, and their desktop factory tests cover them
        // positively; the rest stay out.
        let unimplemented: Set<LiveTranscriptionProviderID> = [
            .apple, .azure, .google, .modulate, .meta
        ]
