...
- **Voice output (TTS)**: ElevenLabs, OpenAI, Azure Cognitive Services, Deepgram Aura (`Sources/SpeakCore/DeepgramTTSCatalog.swift`), Soniox TTS v2 (`tts-rt-v2`, 60+ languages; `Sources/SpeakCore/SonioxTTSCatalog.swift`), and macOS system voices. iOS OpenClaw can route voice output through Deepgram or Soniox.
