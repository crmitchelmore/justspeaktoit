...
/// capture URL surface established in #1070 (`CaptureLinkParameters`). The two
/// stacks are open in parallel and cannot import each other; whichever lands
/// second should delete its copy and forward to this one, so `lang=en_GB` in a
/// URL and "Language: English (United Kingdom)" in a Shortcut can never mean
/// different things.
